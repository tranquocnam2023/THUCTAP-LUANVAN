...
export default function Sidebar() {
  const categories = [
    { name: '🔥 Sản phẩm nổi bật', isHot: true },
    { name: '📱 Điện thoại IPhone', isHot: false },
    { name: '📱 Điện thoại Samsung', isHot: false },
    { name: '📱 Điện thoại Xiaomi', isHot: false },
    { name: '📱 Điện thoại OPPO', isHot: false },
    { name: '📱 Điện thoại Vivo', isHot: false },
    { name: '📱 Điện thoại Realme', isHot: false },
    { name: '📱 Thương hiệu khác', isHot: false },
